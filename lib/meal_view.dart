        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.symmetric(horizontal: 20), child: Row(
              ...
              children: [
                Text(itemName, style: TextStyle(fontSize: size.width * .065, fontWeight: FontWeight.bold),),
                Text('$price JD', style: TextStyle(color: cs.secondary, fontSize: size.width * .065, fontWeight: FontWeight.bold),
                  textDirection: isAr ? TextDirection.ltr : TextDirection.rtl,),
              ],
            ),),

            if (!isAppetizer) Padding(padding: EdgeInsets.symmetric(horizontal: 20.0), child: Wrap(
              runSpacing: 10,
              spacing: 15,
                ...
                return Transform.translate(
                  ...
                  child: Container(
                    ...
                    child: Row(spacing: 5, mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.tag, color: cs.secondary,), Text('${components[menuItem['c'][i]][isAr ? 1 : 0]}', style: TextStyle(fontWeight: FontWeight.bold,
                            color: cs.secondary),)
                    ],),
                  ),
                );
            ...
            if (!isAppetizer && cat != 'Hotdog') Padding(padding: EdgeInsets.symmetric(horizontal: 20), child: Row(
              ...
              children: [
                ...
                SizedBox(
                  height: 40,
                  child: Row(textDirection: Directionality.of(context) == TextDirection.rtl ? TextDirection.ltr : TextDirection.rtl, children: [
                    GestureDetector(
                      onTap: () {
                        if (grams != minGrams) {
                          setState(() {
            ...
            Padding(padding: EdgeInsets.symmetric(horizontal: 15), child: ElevatedButton(onPressed: () {

            }, child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              spacing: 10,
              children: [
                Text(dic.mv_post, style: TextStyle(fontSize: size.width * .04125),),
